					...
					<div class="row">
						<div class="small-12 columns">
							<label>Equipment Type <i class="fa fa-asterisk required_mark"></i></label>
							<select name="equip.id" id="form-equipCategory" onchange="Equipment.changeCategory();">
							...
							<label>Name of Purchased Equipment <i class="fa fa-asterisk required_mark"></i></label>
		          <input type="text" name="name" value="${obj.name}" id="form-equipName" maxlength="50"/>						
			        ...
			        <label>Purchase Price ($) <i class="fa fa-asterisk required_mark"></i></label>
				      <div class="row collapse">
				        <div class="small-2 columns">
				          <span class="prefix">$</span>
				        </div>
				        <div class="small-5 columns">
				          <input type="text" id="cost" name="cost" value="${obj.cost ? obj.cost : 10000}" maxlength="7"/>
				        </div>
				        <div class="small-2 columns">
						...
						<div class="small-6 columns">
							<label>Useable Life (yrs) <i class="fa fa-asterisk required_mark"></i></label>
							<div class="row">
				    		<div class="small-5 columns">								
			        ...
			        <label>Annual Service Contract <i class="fa fa-asterisk required_mark"></i></label>
				      <div class="row collapse">
				        ...
				        <div class="small-5 columns">
				          <input type="text" name="annualServiceContract" value="${obj.annualServiceContract ? obj.annualServiceContract : 1200}" maxlength="6" placeholder="" />
				        </div>
				        <div class="small-2 columns">
				          <span class="postfix">.00</span>
				        </div>
						...
						<div class="small-6 columns">
							...
							<div class="row">
				    		<div class="small-5 columns">
				    			<input type="text" name="annualBillableHours" value="${obj.annualBillableHours ? obj.annualBillableHours : 2000}" maxlength="4" placeholder="" />
				    		</div>
				    	</div>
						</div>
						<div class="small-6 columns">&#160;</div>				    
