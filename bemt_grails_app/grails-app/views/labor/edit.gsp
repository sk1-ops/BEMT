<html>
	<head>
		...
		<title>Edit Labor Cateogory</title>
	</head>
	<body>
		<!--// header //-->
		<g:render template="header" model="['title':'Edit Labor Category', 'bc':'Edit']"/>    
				...
				<g:form url="[resource:obj, action:'update']">
	     		<div class="form_required"><i class="fa fa-asterisk required_mark"></i> denotes required field</div>
					...
					<div class="ctl-btn-group">
						...
						<bemt:button controller="labor" action="index" function="return confirm('Are you sure you want to cancel without saving your changes?');">Cancel</bemt:button>
					</div>
				</g:form>
			</div>
		</div>
