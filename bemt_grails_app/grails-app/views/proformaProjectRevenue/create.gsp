<html>
	...
	<body>
		...
		<!--// header //-->
		<g:render template="header" model="['page':'proforma', 'title':'Other Project Revenue', 'bc':'Project', 'bcId':project]"/> 	
		...
		<div class="row">
			<div class="small-7 columns">
				<g:form url="[resource:obj, action:'save']">
					...
					<g:actionSubmit onclick="return Proforma.checkOther();" class="save button bemtbutton radius" action="save" value="Save Project Revenue"></g:actionSubmit>			
