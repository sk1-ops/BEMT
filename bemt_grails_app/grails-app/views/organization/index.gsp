...
<%@ page import="com.provia.bemt.domain.Organization" %>
<!DOCTYPE html>
<html>
	<head>
		...
		<div id="list-organization" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="organization.owner.label" default="Owner" /></th>
				...
				<g:each in="${organizationInstanceList}" status="i" var="organizationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: organizationInstance, field: "owner")}</td>
